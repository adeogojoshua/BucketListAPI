...
<div>
        ...
        <div class="parallax filter filter-color-black">
            <!-- <div class="image" style="background-image: url('{{ asset('img/background-main.jpg') }}')">
            </div> -->
            <div class="container">
                <div class="content">
    ...
    <!-- class="section" id="firstSection">
        ...
        <!-- class="parallax parallax-small">
            <!-- <div class="image" style="background-image: url('{{ asset('assets') }}/img/office-4.jpeg')"></!--> -->
        </!-->
    </!-->
    ...
    <div class="section section-our-projects section-our-projects-fluid">
        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-lg-4 col-md-6 col-sm-6">
                    <div class="project">
                        <!-- <img src="{{ asset('assets') }}/img/project-5.jpg" /> -->
                        <a class="over-area" href="#gaia">
                            <div class="content">
                ...
                <div class="col-lg-4 col-md-6 col-sm-6">
                    <div class="project">
                        <!-- <img src="{{ asset('assets') }}/img/project-6.jpg" /> -->
                        <a class="over-area" href="#gaia">
                            <div class="content">
                ...
                <div class="col-lg-4 col-md-6 col-sm-6">
                    <div class="project">
                        <!-- <img src="{{ asset('assets') }}/img/project-4.jpg" /> -->
                        <a class="over-area" href="#gaia">
                            <div class="content">
                                <label class="label label-danger label-fill">Website Redesign</label>
    ...
    <div class="section section-get-started">
        <div class="parallax filter filter-color-black">
            <!-- <div class="image" style="background-image: url('{{ asset('assets') }}/img/header-13.jpeg')"> -->
            </div>
            <div class="container">
                <div class="title-area">
